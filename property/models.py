...
class Complaint(models.Model):
    ...
    author = models.ForeignKey(User, verbose_name="Автор жалобы", related_name="complaints" ,on_delete=models.CASCADE)
...
class Owner(models.Model):
    ...
    owned_flats = models.ManyToManyField(Flat, related_name="flat_owner", verbose_name="Квартиры в собственности", blank=True)
    def __str__(self):
        return f"{self.owner}"